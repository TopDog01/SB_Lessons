...
int main()
{
    ...
    std::string answer;
    int counter; // Объявляем переменную counter вне цикла
    ...
    // Проверяем количество попыток после завершения цикла
    if (counter >= 3) {
        std::cout << "Вы трижды ответили неверно и оказались съедены!\n";
    }
